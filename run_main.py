...
def parse_args():
    ...
    parser.add_argument('--add_noise', type=bool, default=True, help='Boolean for adding salt & pepper noise to input image')

    # parser.add_argument('--dim_z', type=int, default='20', help='Dimension of latent vector', required = True)
    parser.add_argument('--dim_z', type=int, default='20', help='Dimension of latent vector')
